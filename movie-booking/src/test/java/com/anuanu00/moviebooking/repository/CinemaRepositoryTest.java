...
public class CinemaRepositoryTest {
    ...
    @Test
    @DisplayName("getCinemaById Should Return null Given Cinema Id If Cinema not found")
    public void getCinemaById_GivenCinemaId_ShouldReturnNullIfNotPresent() {
        // Arrange
        String cinemaId = "4";
        // Act
    ...
    @Test
    @DisplayName("saveCinema Should Save Cinema")
    ...
    @Test
    @DisplayName("updateCinema Should Update Cinema")
    public void updateCinema_ShouldUpdateCinema() {
        // Arrange
        Cinema expectedCinema = new Cinema("3", "Updated-CinemaC");
        // Act
