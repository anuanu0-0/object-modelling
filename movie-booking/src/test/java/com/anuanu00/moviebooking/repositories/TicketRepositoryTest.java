...
public class TicketRepositoryTest {
    ...
    public void setup() throws ParseException {
        ...
        Customer customer = new Customer("1", "CustomerA", "test1@gmail.com");
        Show show = new Show("1",  new SimpleDateFormat("dd/MM/yyyy HH:mm").parse("20/07/2021 13:30"),
    ...
    @Test
    @DisplayName("getTicketId method Given Ticket Id Should Return Ticket")
    public void getTicketId_GivenTicketId_ShouldReturnTicket() throws ParseException {
        // Arrange
        Customer customer = new Customer("1", "CustomerA", "test1@gmail.com");
        Show show = new Show("1",  new SimpleDateFormat("dd/MM/yyyy HH:mm").parse("20/07/2021 13:30"),
                new SimpleDateFormat("dd/MM/yyyy HH:mm").parse("20/07/2021 16:00"),
    ...
    @Test
    @DisplayName("getTicketId method Given Ticket Id Should Return Null")
    public void getTicketId_GivenTicketId_ShouldReturnNullIfNotPresent() {
        // Arrange
        Integer ticketId = 2;
        // Act
        Ticket expectedTicket = ticketRepository.getTicketById(ticketId);
        // Assert
    ...
    public void saveTicket_ShouldSaveTicket() throws ParseException {
        // Arrange
        Customer customer = new Customer("2", "CustomerB", "test2@gmail.com");
        Show show = new Show("1",  new SimpleDateFormat("dd/MM/yyyy HH:mm").parse("20/07/2021 13:30"),
                new SimpleDateFormat("dd/MM/yyyy HH:mm").parse("20/07/2021 16:00"),
                new Screen("1","ScreenA"),
                new Cinema("1","CinemaA"),
                new Movie("1","MovieA",120));
        Seat seat2_1 = new Seat("2#1", 2, 1);
        Seat seat2_2 = new Seat("2#2", 2, 2);
        List<Seat> seatList = new ArrayList<>(List.of(seat2_1, seat2_2));
    ...
    @Test
    @DisplayName("removeTicket Method Should Remove Ticket")
